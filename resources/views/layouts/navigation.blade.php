                ...
                @auth
                    <div class="relative" @click.away="userMenu = false">
                        ...
                        <div x-show="userMenu" x-transition class="absolute right-0 mt-2 w-48 rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5" style="display: none;">
                            <a href="{{ route('profile') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Profile Info</a>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1 px-4">
            @auth
                ...
                <a href="{{ route('profile') }}" class="block py-1 text-sm text-gray-600 hover:text-gray-900">Profile Info</a>
